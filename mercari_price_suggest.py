...
def main() -> None:
    ...
    logging.basicConfig(filename='mercari_price_suggest.log', level=logging.INFO, format='%(asctime)s - %(levelname)s - %(message)s')


    logging.info('Starting Mercari Price Suggest script')
    ...
    logging.info('Category splitting completed')
    ...
    logging.info('Null value replacement completed')
    ...
    logging.info('Memory cleaning completed')
    ...
    logging.info('Feature vectorization completed')
    ...
    logging.info('Feature encoding completed')
